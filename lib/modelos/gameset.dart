...
//Un set finaliza cuando uno de los dos jugadores llega a 6 juegos con 2 de ventaja o cuando llega a 7 con 
//dos juegos de ventaja o cuando gana un tiebreak

class gameSet{
  bool? addPuntoLocal(){}
  bool? addPuntoVisitante(){}
  Map<String, String>? getGameSet(){}
}